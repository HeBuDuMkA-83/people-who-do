...
public class EventManager {
    ...
    private void init() {
        ...
        Event p = new Event(1, "«Чего хочет Пермь»", "Хакатон", " Участники обсудят и разработают идеи социальных и IT-проектов, которые реально могут изменить город и жизнь горожан. Кем бы вы ни были: городским активистом, блогером, журналистом, дизайнером, программистом — вы можете собрать команду и при помощи менторов реализовать свою идею, сделать город удобным и красивым. Победитель хакатона получит право на доработку проекта в размере 60 тыс. рублей.");
        ...
        p = new Event(2, "Гаджетстрой", "разработка гаджетов", "Гаджетстрой - это конкурс по созданию умных девайсов, которые сделают нашу жизнь лучше. \n" +
